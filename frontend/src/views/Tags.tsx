...
export default function Tags() {
  ...
  const filtered = search
    ? tags.filter((t: TagItem) => t.name.toLowerCase().includes(search.toLowerCase()))
    : tags
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 h-10 rounded-lg bg-primary-500 text-white text-sm font-medium hover:bg-primary-600 transition-colors"
          >
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {filtered.map((tag: TagItem) => (
            <div
              key={tag.id}
              className="bg-card-bg border border-card-border rounded-xl p-4 card-hover group"
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="p-1 rounded-md hover:bg-white/5 text-text-muted hover:text-text-secondary transition-colors">
